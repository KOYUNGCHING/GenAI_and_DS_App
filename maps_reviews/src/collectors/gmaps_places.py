...
def main():
    ...
    ap.add_argument("--areas", required=True, help="CSV with columns: city,area_name,keyword")
    ...
    for _, row in areas.iterrows():
        ...
        # 預設用「…咖啡廳」
        query = kw if kw else f"{city}{area} 咖啡廳"
        ...
        all_parts.append(df); total += len(df); time.sleep(0.8)
